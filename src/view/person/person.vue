            ...
            <div class="user-information">
              <ul>
                <li>
                  ...
                  昵称：{{ userStore.userInfo.nickName }}
                </li>
                <el-tooltip
                  class="item"
                  effect="light"
                  ...
                  <li>
                    ...
                    部门：{{ userStore.userInfo.dept.deptName }}
                  </li>
                </el-tooltip>
                <!-- <li>
                  <el-icon>
                ...
                <el-tooltip
                  class="item"
                  effect="light"
                  :content="userStore.userInfo.authorities[0].authorityName"
                  placement="top">
                  <li>
                    <el-icon>
                      <medal />
                    </el-icon>
                    角色：{{ userStore.userInfo.authorities[0].authorityName }}
                  </li>
                </el-tooltip>
              </ul>
            </div>
...
import { setSelfInfo, changePassword } from '@/api/user';
